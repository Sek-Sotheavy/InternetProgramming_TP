        ...
        <main>
                ...
                <div class="py-2">
                        <form @submit="onSubmit" method="post">
                                <div class="grid grid-cols-4 py-2 gap-24 px-2 bg-gray-100">
                                        <div>
                                                <input v-model="name" type="text" placeholder="Name" required class="rounded-lg p-1" />
                                        </div>
                                        <div>
                                                <label for="category">Choose a category:</label>
                                                <select v-model="categoryId" name="category" required
                                        ...
                                        <div>
                                                <input v-model="desc" required type="text" placeholder="Description" class="rounded-lg p-1" />
                                        </div>
                                        <div>
                                ...
                                <tr v-for="item in items" :key="item.name">
                                        ...
                                        <td>
                                                <div class="flex flex-col space-y-2">
                                                        ...
                                                        <button class="hover:text-green-600 hover:font-bold" v-on:click="deleteproduct(product._id)">Delete </button>
                                                </div>
                                        </td>
                                </tr>
                        </table>
