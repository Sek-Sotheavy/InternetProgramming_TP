                                ...
                                <tr v-for="cate in categories" :key="cate.name">
                                        ...
                                        <td>
                                                <div class="flex flex-col space-y-2">
                                                        <button class="hover:text-green-600 hover:font-bold" @click="updatecate(cate)">Edit</button>
                                                        <button class="hover:text-green-600 hover:font-bold" @click="deletecate(cate)">Delete </button>
                                                </div>
                                        </td>
                                </tr>
                        </table>
