 <script>
  ...
  export default {
    ...
    methods: {
      ...
      edit_new(){
        const data = {category_name: this.new_category.name, _id: this._id}
  ...
  <template>
    ...
    <main>
      ...
      <div class="right-side">
        <div class="action">
          <p>Category</p>
          <button @click="open_category" style="margin-top: 5px;border-radius: 7px;margin-right: 10px;background-color: rgb(34, 161, 190); ">Add new</button>
        </div>
        ...
        <table class="GeneratedTable">
          ...
          <tbody>
            <tr v-for="category in categories" :key="category_.id">
  ...
  * {
  ...
  li{
    background-color:  rgb(12, 185, 180);
  }
  li:active{
    background-color: rgb(43, 174, 206);
  }
  ...
  header {
    ...
    z-index: 999;
    padding: 0 40px;
    background-color: rgb(179, 242, 245);
  }
